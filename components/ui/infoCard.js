...
const InfoCard = ({ title, unit, quantity, subUnit, color }) => {
    return (
        <section>
            <Card className={'transition duration-1000 ease-in-out text-opacity-50 hover:text-opacity-100  dark:bg-secondary-400 bg-primary-50/80 hover:bg-primary-50 transform  text-black dark:text-white'}>
