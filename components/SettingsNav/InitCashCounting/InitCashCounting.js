...
export default function InitCashCounting ({
    ...
    const {
        getLastIndicatorsCashBalanceEnding,
        createBalanceBeginnings,
        openDrawer
    } = useCashBalanceStore(
        ({
            getLastIndicatorsCashBalanceEnding,
                                            ...
                                            <div className=" space-y-12">
                                                <div className="flex flex-row w-full space-x-4">
                                                    <InitCashReconciliationCard
                                                        title={
                                                            lastBalance
                                                                ? 'Saldo cierre de caja anterior'
                                                                : 'No se ha registrado un cierre de caja anterior'
                                                        }
                                                        total={
                                                            lastBalance?.total_ending_real_cash_balance
                                                                ? formatterNumber(
                                                                    lastBalance?.total_ending_real_cash_balance
															  )
                                                                : '-'
                                                        ...
                                                        img={credit}
                                                        detail={
                                                            'La cantidad de saldo anterior no siempre coincidirá con la cantidad de dinero con la que se inicia la jornada'
                                                        }
                                                    />
                                                </div>
                                                <section className="flex flex-row space-x-3">
                                                    <Button
                                                        variant="shadow"
                                                        className=" w-[10rem] h-[8rem] bg-green-700  text-white font-extrabold text-3xl"
                                                    ...
                                                    <Button
                                                        variant="shadow"
                                                        className=" w-[10rem] h-[8rem] bg-indigo-600 text-white font-extrabold text-3xl shadow-lg"
                                                    ...
                                                    <Button
                                                        variant="shadow"
                                                        className=" w-[10rem] h-[8rem] bg-red-600 text-white  font-extrabold text-3xl shadow-lg"
                                                    ...
                                                    <Button
                                                        variant="shadow"
                                                        className=" w-[10rem] h-[8rem] bg-blue-600 text-white  font-extrabold text-3xl shadow-lg"
                                                        onClick={() =>
                                                            setPayDetailed(paymentDetailed + 10000)
                                                        }
                                                    >
													$10.000
                                                    </Button>
                                                    <Button
                                                        variant="shadow"
                                                        className=" w-[10rem] h-[8rem] bg-orange-600 text-white  font-extrabold text-3xl shadow-lg"
                                                        onClick={() =>
                                                            setPayDetailed(paymentDetailed + 20000)
                                                        }
                                                    >
													$20.000
                                                    </Button>
                                                ...
                                                <Input
                                                    ...
                                                    onValueChange={(value) => {
                                                        if (value) {
                                                            setPayDetailed(parseFloat(value))
                                                        }
                                                    }}
                                                />
                                                <div className="flex flex-col">
													...
													los cálculos del inicio de caja. Esta acción
													representa mi conformidad con la precisión de las
													transacciones y la cantidad de efectivo en la caja.
                                                    </p>
                                                </div>
                                            </div>
                                        </ModalBody>
