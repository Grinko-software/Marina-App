...
const mapperTypeVoucher = {
    [VOUCHER_TYPE.VOUCHER]: VOUCHER_TYPE.VOUCHER,
    [VOUCHER_TYPE.INVOICE]: VOUCHER_TYPE.INVOICE,
    [VOUCHER_TYPE.TICKET]: VOUCHER_TYPE.TICKET,
    factura: VOUCHER_TYPE.INVOICE,
    boleta: VOUCHER_TYPE.TICKET
}
