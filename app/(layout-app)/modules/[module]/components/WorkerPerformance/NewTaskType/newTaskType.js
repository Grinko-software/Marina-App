...
export default function CreateTaskType () {
    ...
    return (
        <section>
            ...
            >
                <ModalContent>
                    <ModalHeader className="flex flex-col gap-1 text-primary-500 dark:text-primary-200">Nuevo tipo de tarea</ModalHeader>
                    <ModalBody>
                    ...
                    <ModalFooter>
                        ...
                        <Button className =" bg-green-500 text-primary-50"
                            onClick={() => { requestCreate(name, notify) }}
                        >
                            Crear
                        </Button>
