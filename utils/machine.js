export const errorsMachine = new Map([
    ...
    ['MR-140',	'dteType = 99 requiere extraData.exemptAmount y el atributo no se encuentra en la petición.'],
    ['MR-141',	'dteType = 99 requiere que extraData.exemptAmount sea igual a amount y no lo es.'],
    ['MR-150',	'dteType dentro de [0, 33, 48] extraData.exemptAmount necesita ser menor a amount.'],
