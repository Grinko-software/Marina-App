...
export const REPORTS_API_URL =
	BASE_MARKET_API_URL + '/report/period-voucher-type-sales'
export const REPORTS_CATEGORY_API_URL =
	BASE_MARKET_API_URL + '/report/period-category-sales'
export const REPORTS_INDICATORS_API_URL =
	BASE_MARKET_API_URL + '/report/period'
export const REPORTS_SALES_TYPES_API_URL =
	BASE_MARKET_API_URL + '/report/period-sales-types'
export const REPORTS_CRITICAL_STOCK_API_URL =
	BASE_MARKET_API_URL + '/report/product-stock'
...
export const SUPPLIER_ASSOCIATION_API_URL =
	BASE_MARKET_API_URL + '/supplier/:id/association/products'
// GET STATUS CASH REGISTER
export const GET_STATUS_CASH_REGISTER =
	'/accounting-event/status/cash-register/:id'
// GET INDICATORS INIT CASH
export const GET_INDICATORS_LAST_BALANCE =
	'/accounting-event/last-balance-ending/:id'
export const GET_INDICATORS_BALANCE_ENDING =
	'/accounting-event/indicators-balance-ending/:id'

export const CREATE_BALANCE_BEGINNINGS =
	'/accounting-event/create/balance-beginnings'
export const CREATE_BALANCE_ENDINGS =
	'/accounting-event/create/balance-endings'
export const CREATE_BALANCE_WITH_DRAWALS =
	'/accounting-event/create/withdrawals'
export const INDICATORS_ACCOUNTING_EVENT = '/accounting-event'

// PRINTER
export const PRINTER_TICKET_API_URL =
	'http://localhost:8090/escpos/receipt/sale'
...
export const PRINTER_BARCODE_API_URL =
	'http://localhost:8090/escpos/receipt/barcode'
export const PRINTER_SUPPLIER_TICKET_API_URL =
	'http://localhost:8090/escpos/receipt/provider'
...
export const TASK_DIFFUCULT_API_URL =
	BASE_MARKET_API_URL + '/task-difficulties'
export const CREATE_TASK_TYPE_API_URL_URL =
	BASE_MARKET_API_URL + '/task-type/create'
export const CREATE_TASK_API_URL_URL = BASE_MARKET_API_URL + '/task/create'
export const TASKS_API_EMPLOYEE_URL_URL =
	BASE_MARKET_API_URL + '/task/:employeeID'
export const TASKS_API_EMPLOYEE_COMPLETE_TASK =
	BASE_MARKET_API_URL + '/task/:taskID/:employeeID'
export const TASKS_API_EMPLOYEE_START_TASK =
	BASE_MARKET_API_URL + '/task/start/:taskID/:employeeID'
export const TASKS_API_EMPLOYEE_COMPLETE_TASK_IMAGE =
	BASE_MARKET_API_URL + '/task/image/:taskID'

export const TASKS_PAYMENT_API_URL_URL =
	TASKS_API_URL_URL + '/payment/:employeeId' // lista de lo que se debe pagar
